module top_LAYER3 #(
    ...
    output         [5:0]        o_layer2buf_ADR,
    output                      o_layer2buf_EN,
    output                      o_LAYER3_DONE,
    output                      o_LAYER3_ALL_DONE,
...
local_control_layer3 local_control_layer3 (
        .i_CLK(i_CLK),
        .i_RST_n(i_RST_n),
        .i_LAYER2_DONE(i_LAYER2_DONE),
        ...
        .o_COL_ADDR(o_layer2buf_ADR),
        .o_layer2buf_EN(o_layer2buf_EN),
        .o_WBUF_EN(wr_wbuf_en),
        .o_WBUF_SEL(wr_wbuf_sel),

        .o_LAYER3_DONE(o_LAYER3_DONE),
        .o_LAYER3_ALL_DONE(o_LAYER3_ALL_DONE)
);
...
localparam COEFF = 17'b0_0000_0001_1010_0001;
