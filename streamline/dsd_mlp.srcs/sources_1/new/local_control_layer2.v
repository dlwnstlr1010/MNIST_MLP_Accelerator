module local_control_layer2(
    ...
    output  reg     [6:0]   o_COL_ADDR, //input
    output  reg             o_layer1buf_EN,
    output  reg             o_WBUF_EN,
    output  reg             o_WBUF_SEL,

    output  reg             o_LAYER2_DONE,
...
always @(posedge i_CLK) begin
    case (current_state)
        ...
        4'd7:begin
            ...
            if(o_WBUF_SEL==1)o_LAYER2_DONE<=1;
            o_ACC_RD<=0;
        end
