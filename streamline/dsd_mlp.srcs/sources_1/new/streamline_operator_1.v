...
module streamline_operator_1(
    ...
    // MAC �??중치
    input   wire    [8*128-1:0]    i_MAC_WEIGHT_PACKED,
...
// MAC �??중치 ?��?��
wire signed [7:0]  i_MAC_WEIGHT[0:127];
`UNPACK_ARRAY(8, 128, i_MAC_WEIGHT_PACKED, i_MAC_WEIGHT, unpk_wrom)
...
// 출력 wire ?��?��
wire signed [31:0] mac_output[0:127];
wire signed [31:0] acc_out[0:127];
//wire signed [7:0] acc_out[0:127];

genvar i;
generate
    for(i=0; i<128; i=i+1) begin : mac_gen
